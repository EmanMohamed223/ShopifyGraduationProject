...
//        
//        NetworkService.fetchData (url: getURL(endPoint: getURL(endPoint: "products.json")!.appending(chooseMainCategory (index : 0) )),
...
//        let expectation = expectation(description: "Waiting for API")
//        
//        NetworkService.fetchData (url: getURL(endPoint: getURL(endPoint: "products.json")!.appending(chooseMainCategory (index : 1) )),
//              compiletionHandler: { data in
//            guard let response : ResponseProducts = data
//            else
//            {
...
//            }
//         
//            XCTAssertNotEqual(response.smart_collections.count, 0 , "Women Category Api Failed")
//            expectation.fulfill()
//        })
//        waitForExpectations(timeout: 5,handler: nil)
//    }
...
//        let expectation = expectation(description: "Waiting for API")
//        
//        NetworkService.fetchData (url: getURL(endPoint: getURL(endPoint: "products.json")!.appending(chooseMainCategory (index : 2) )),
//              compiletionHandler: { data in
//            guard let response : ResponseProducts = data
//            else
//            {
...
//        let expectation = expectation(description: "Waiting for API")
//        
//        NetworkService.fetchData (url:getURL(endPoint: getURL(endPoint: "products.json")!.appending(chooseMainCategory (index : 3) )),
//              compiletionHandler: { data in
//            guard let response : ResponseProducts = data
//            else
//            {
